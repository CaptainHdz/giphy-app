...
const topics = ["dogs", "cats", "iron man", "fries"];
...
function displayButtons() {
    ...
    newBtn.addClass("m-1 btn shadow")
...
const mainURL = "https://api.giphy.com/v1/gifs/search?q="+ query + "&api_key=hXBN5LO4EL4KjY60GVR4Pxz5Tyh5zcNN&limit=12"
$.ajax({
url: mainURL,
method: "GET"
